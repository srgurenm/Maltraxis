...
const Synopsis = ({ t, resonance }) => {
  return (
    <section id="sinopsis" className={`py-20 border-y relative ${resonance === 'umbrío' ? 'bg-black/90 border-white/5' : 'bg-white border-slate-200'}`}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <div className={`space-y-6 leading-relaxed text-justify lg:text-center text-lg ${resonance === 'umbrío' ? 'text-slate-300' : 'text-slate-700'}`}>
            <p>{t.sinopsis_p1}</p>
            <p>{t.sinopsis_p2}</p>
          </div>
        </div>
