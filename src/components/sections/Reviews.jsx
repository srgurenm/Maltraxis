...
const reviewsData = [
  {
    ...
    initials: 'JM',
    rating: 5,
    text: '\"Maltraxis es una obra maestra del Magipunk. El sistema de magia tiene un costo tan real y crudo que temes por el protagonista en cada página. Gur me atrapó desde el primer momento. ¡Totalmente recomendado!\"',
    platform: 'Amazon (Compra Verificada)',
  ...
  },
  {
    ...
    initials: 'AL',
    rating: 5,
    text: '\"Por fin una fantasía oscura que subvierte el cliché de la luz salvadora. La ambientación gótica e industrial te envuelve por completo. Es como mezclar Arcane con Blade Runner, pero con una identidad propia brutal.\"',
    platform: 'Goodreads',
  ...
  },
  {
    ...
    initials: 'DS',
    rating: 5,
    text: '\"No podía soltarlo. La combinación de trama detectivesca con un lore cósmico gigantesco está perfectamente equilibrada. Si te gusta Sanderson o Abercrombie, este libro te va a volar la cabeza. Esperando el segundo.\"',
    platform: 'Amazon',
